...
pages["about.html"] = page(
    ...
    <section class="section bg-cream">
      <div class="wrap prose">
        ...
        <p>My background includes work as a talent in entertainment. That presence is here as warmth and connection, the ability to make a conversation feel alive, not as a performance.</p>
      </div>
    </section>
    <section class="section">
